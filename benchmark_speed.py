...
def main() -> None:
    ...
    if args.method == "dense":
        prefill_inputs["position_ids"] = torch.arange(input_ids.shape[1], device=device).unsqueeze(0)
    ...
    out_file = out_dir / f"speed_{run_name}_{args.method}_prompt{input_ids.shape[1]}_gen{args.generate_tokens}_budget{args.kv_budget}.json"
